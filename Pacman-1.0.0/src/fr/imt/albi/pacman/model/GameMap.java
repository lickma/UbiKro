...
public class GameMap {
	...
	private int pacmanY;
	/**
	 * Tableau Ã  deux dimension de figure contenant toute les figures de la map case
	 * par case
	 */
	...
	private int nbGom;
	/**
	 * La position sur la map de chaque fantÃ´me en début de niveau : Un liste de
	 * couple (x,y)
	 */
	...
	/*******************************************************************
	 * Un fichier map.txt définira un niveau de jeu La premiÃ¨re ligne contient les
